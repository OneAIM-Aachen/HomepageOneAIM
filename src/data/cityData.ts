...
const aachenConnectTimeline: TimelineRow[] = [
      ...
      { date: "Week 7–9", dot: "filled", title: "Project Preparation Sessions",
        ...
        partners: [
          ...
          { name: "Alpamayo",
            detail: "How to: Code with AI, with Christoph Netsch (Co-Founder)",
            logo: "/images/partners/alpamayo-icon.svg" },
  ...
  frankfurt: {
    ...
    connectSecuredPartners: [
      { name: "Cinven", wide: true,
        text: "European private equity fund investing heavily in healthcare. Hear their vision for the field and lessons from investments like Stada.",
        logo: "/images/partners/cinven.svg" },
      { name: "Cardiopulmonary Institute", wide: true,
        text: "Goethe University Excellence Cluster for fundamental cardiovascular research. Session on AI in research with the Head of Translational Cardiovascular Imaging.",
        logo: "/images/partners/uniklinikum-frankfurt.svg" },
      { name: "Futury",
        text: "The Startup Factory: a leading hub helping startups build sustainable growth strategies. Connect with the heads of Futury and their operations.",
        logo: "/images/partners/futury-icon.png" },
      { name: "Hessian.AI", wide: true,
        text: "The Hessian Center for Artificial Intelligence, uniting academia, industry and startups to accelerate applied AI. Explored up close in the batch program.",
        logo: "/images/partners/hessian-ai.svg" },
      { name: "Nordic Capital", wide: true,
        text: "Leading private equity investor funding startups to scale, enter new markets and accelerate growth. Learn what investors look for before they commit.",
